...
open (unit=21, &
     &      file='/home/eejmh/Desktop/read_radar_mirai/mirai151123_000000.cappi.dbz', &
     &      form='unformatted', &
     &      access='direct',recl=ixyz*4)
open (unit=22, file='/home/eejmh/Desktop/read_radar_mirai/mirai151123_000000.cappi.dbz.txt')
irec=0
   do k=1,kxyz
      do j=1,jxyz
         irec=1+irec
